<template>
    <div class="bg-white w-full flex justify-between items-center py-2 rounded-xl px-8 mt-2 <md:px-2">
        <div class="flex items-center <sm:w-1/5">
            <h3 class="ml-2 text-lg <sm:text-sm" :class="{'text-yellow-400': index === 0, 'text-gray-400': index === 1, 'text-amber-800': index === 2}">{{ index + 1 }}.</h3>
            <h3 class="ml-2 text-lg <sm:text-sm" :class="{'text-yellow-400': index === 0, 'text-gray-400': index === 1, 'text-amber-800': index === 2}">{{ stats.better }}</h3>
        </div>
